...
namespace MicrosoftResearch.Infer.Models.User
{
	...
	public partial class Model0_VMP : IGeneratedAlgorithm
	{
		...
		/// <summary>Message from use of 'vVector18'</summary>
		public Dirichlet vVector18_use_B;
		/// <summary>Message to marginal of 'vVector18'</summary>
		public Dirichlet vVector18_marginal_F;
		...
		public void Changed_ThetaPrior_Init_numberOfIterationsDecreased_NumWordsInDoc_WordCounts_PhiPrior_Words(bool initialise)
		{
			...
			this.vVector18_use_B = ArrayHelper.MakeUniform<Dirichlet>(this.thetaPrior);
		...
		public void Changed_numberOfIterationsDecreased_ThetaPrior_NumWordsInDoc_WordCounts_PhiPrior_Words(int numberOfIterations)
		{
			...
			this.vVector18_marginal_F = ArrayHelper.MakeUniform<Dirichlet>(this.thetaPrior);
			...
			// Create array for replicates of 'vVector18_rep_rpt0_B'
			DistributionRefArray<Dirichlet,Vector> vVector18_rep_rpt0_B = new DistributionRefArray<Dirichlet,Vector>(this.numWordsInDoc);
			for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
				vVector18_rep_rpt0_B[WInD] = ArrayHelper.MakeUniform<Dirichlet>(this.thetaPrior);
			}
			DistributionRefArray<Dirichlet,Vector> vVector18_rep_B = default(DistributionRefArray<Dirichlet,Vector>);
			// Create array for 'vVector18_rep' Backwards messages.
			vVector18_rep_B = new DistributionRefArray<Dirichlet,Vector>(this.numWordsInDoc);
			for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
				vVector18_rep_B[WInD] = ArrayHelper.MakeUniform<Dirichlet>(this.thetaPrior);
			}
			for(int T = 0; T<5; T++) {
			...
			for(int iteration = this.Changed_numberOfIterationsDecreased_ThetaPrior_NumWordsInDoc_WordCounts_PhiPrior_Words_iterationsDone; iteration<numberOfIterations; iteration++) {
				// Message to 'vVector18_marginal' from Variable factor
				this.vVector18_marginal_F = VariableVmpOp.MarginalAverageLogarithm<Dirichlet>(this.vVector18_use_B, this.thetaPrior, this.vVector18_marginal_F);
				for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
				...
				for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
					_hoist = DiscreteFromDirichletOp.SampleAverageLogarithm(this.vVector18_marginal_F, _hoist);
					WInD = this.numWordsInDoc-1;
				}
				for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
					...
					// Message to 'vVector18_rep_rpt0' from Discrete factor
					vVector18_rep_rpt0_B[WInD] = DiscreteFromDirichletOp.ProbsAverageLogarithm(topic_marginal_F[WInD], vVector18_rep_rpt0_B[WInD]);
					// Message to 'vVector18_rep' from Enter factor
					vVector18_rep_B[WInD] = PowerPlateOp.ValueAverageLogarithm<Dirichlet>(vVector18_rep_rpt0_B[WInD], this.wordCounts[WInD], vVector18_rep_B[WInD]);
				}
				// Message to 'vVector18_use' from Replicate factor
				this.vVector18_use_B = ReplicateOp.DefAverageLogarithm<Dirichlet>(vVector18_rep_B, this.vVector18_use_B);
				for(int WInD = 0; WInD<this.numWordsInDoc; WInD++) {
					for(int T = 0; T<5; T++) {
		...
		public Dirichlet VVector18Marginal()
		{
			return this.vVector18_marginal_F;
		}
